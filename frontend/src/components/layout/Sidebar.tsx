import {
  ...
  Moon, Server, Settings as SettingsIcon, ShieldCheck, Sun, Terminal as TerminalIcon, Users, Wand2,
} from "lucide-react";
...
export function Sidebar() {
  ...
  return (
    <aside className="relative z-10 flex w-[252px] shrink-0 flex-col border-r border-line-subtle bg-bg-raised/40 backdrop-blur-md">
      {/* Brand */}
      <div className="flex items-center gap-3 px-5 py-5">
        ...
        <div className="flex flex-col leading-tight">
          <span className="display text-[18px] tracking-tight text-ink-1">XenRelay</span>
      ...
      <div className="flex items-center justify-between border-t border-line-subtle px-3 py-3">
        <button
          ...
          className="inline-flex items-center gap-1.5 rounded-md px-2 py-1.5 text-[12px] text-ink-2 hover:text-ink-1 hover:bg-bg-inset transition-colors"
        >
        ...
        <div className="inline-flex items-center gap-0.5 rounded-md border border-line-subtle bg-bg-inset/60 p-0.5">
          <ThemeBtn
            active={theme === "dark"}
